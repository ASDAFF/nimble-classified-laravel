                            ...
                            <form id="add_category" method="post" role="form" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control" value="{{ ( isset($category) && $category->name != '')? $category->name: '' }}" id="title" placeholder="Category title" required >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label">Price Options</label>
                                                <input type="text" name="price" value="{{ ( isset($category) && $price_option != '')? $price_option: '' }}" class="form-control" placeholder="year,month,week,day">
                                                <small>please add comma separated values</small>
                                            </div>
                                        </div>
                                    </div>
