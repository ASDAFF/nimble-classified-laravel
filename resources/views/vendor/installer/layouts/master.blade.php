...
<html>
    <head>
        ...
        <link href="{{ str_replace('public', '', asset('')).'admin_assets/css/bootstrap.min.css' }}" rel="stylesheet"/>
    ...
    <body>
        ...
        <script src="{{ str_replace('public', '', asset('')).'admin_assets/js/bootstrap.min.js' }}" type="text/javascript"></script>
