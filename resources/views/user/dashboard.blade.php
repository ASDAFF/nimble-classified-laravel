                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7 col-xs-4 col-xxs-12">
                                <h3 class="no-padding text-center-480 useradmin">
                                    ...
                                    <span class="page-sub-header-sub small text-info">Active user on website since {{ $user->created_at->diffForHumans() }}</span>
                                    @if(Auth::user()->email_verify == 0)
                                      <p class="bg-danger text-white m-t-10">Please confirm your email</p>
                                    @endif
                                </h3>
                            </div>
                            <div class="col-md-5 col-xs-8 col-xxs-12">
                                <div class="header-data text-center-xs">
                                    ...
                                    <div class="hdata">
                                        ...
                                        <div class="mcol-right">
                                            <p><a href="#">{{ \App\Ads::where(['user_id' => $user->id])->count() }}</a><em>Ads</em></p>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                    {{--<div class="hdata">
                                        ...
                                        <form class="form-horizontal" id="profile_setting" role="form">
                                            ...
                                            <div class="form-group  hidden send_code_btn">
                                                ...
                                                <div class="col-md-9 bg-primary" style="padding: 10px">
                                                    ...
                                                    <button id="send_code" class="btn btn-default" type="button">Send Code <i class="fa fa-spin fa-spinner hidden"></i></button>
                                                </div>
                                            </div>
                                            ...
                                            <div id="load_comune">
                                                @if($comune != '')
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Comune</label>
                                                        <div class="col-sm-9">
