        ...
        <div class="content">
            <div class="col-xs-12">
                <div class="page-title-box">
                    <h4 class="page-title">Add Groups Fields</h4>
                    <ol class="breadcrumb p-0 m-0">
                        <li> <a href="{{ url('dashboard') }}">Dashboard</a></li>
                        <li class="active">Add Group Fields</li>
                    </ol>
            ...
            <div class="col-xs-12">
                ...
                <div class="card-box">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <a href="{{ route('groups.create') }}" class="btn btn-primary btn-sm pull-right m-b-10" > Add new Group  </a>
                        </div>
                        @if(count($groups) > 0)
                                ...
                                <div class="portlet">
                                    ...
                                    <div id="group_{{$val['id']}}" class="panel-collapse collapse @if (session('id') && $val['id'] == session('id')) in @endif"  @if (session('id') && $val['id'] == session('id') ) aria-expanded="true" @else aria-expanded="false" style="height: 0px;" @endif>
                                        <div class="portlet-body">
                                            <!-- Button trigger modal -->
                                            <div class="col-md-12">
                                                <button type="button" class="btn btn-primary btn-sm pull-right m-b-10" onclick="$('#group_id').val({{$val['id']}});$('#category_id').val({{$val['category_id']}}); $('#newFieldTitleId strong').html('({{ ucwords($val['title']) }} -> {{ ucwords($val['group_cat']['name']) }} )')"  data-toggle="modal" data-target="#newFieldModal"> Add new field  </button>
                                            </div>
                                            <div class="clearfix"></div>
                                            @if( count($val['group_fields']) > 0 )
                                                            ...
                                                            <form action="{{route('group_fields.store')}}" id="form_Group{{$value['id']}}" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="radio radio-info radio-inline">
                                                                        ...
                                                                        <label for="is_icon_{{ $value['id'] }}">Add Icon</label>
                                                                    </div>
                                                                    <div class="radio radio-inline">
                                                                        ...
                                                                        <label for="is_image_{{ $value['id'] }}">Add Image </label>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group @if($value['image'] != '') hidden @endif  " id="icon-div_{{ $value['id'] }}">
                                                                    <label for="">Icons:</label><br>
                                                                    <div class="btn-group">
                                                                        <button type="button" onclick="$('#modal_hidden_id').val({{ $value['id'] }})"  class="btn btn-default" value="" data-toggle="modal" data-target="#iconModal">Add Icon</button>
                                                ...
                                                @endforeach
                                                @else
                                                <p class="text-danger"> You haven't added any <strong> {{ ucwords($val['title']) }} </strong> group field yet! </p>
                                            @endif
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="newFieldTitleId">Add New <strong class="text-info"></strong> Field</h4>
                </div>
                <div class="modal-body">
                    <form action="{{route('group_fields.store')}}" id="form_Group" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group" id="icon-div_0">
                            <label for="">Icons:</label><br>
                            <div class="btn-group">
                                <button type="button" onclick="$('#modal_hidden_id').val(0)"  class="btn btn-default" value="" data-toggle="modal" data-target="#iconModal">Add Icon</button>
